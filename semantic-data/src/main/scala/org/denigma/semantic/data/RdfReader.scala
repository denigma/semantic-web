 ...
 */
class RdfReader(fileName:String,con:BigdataSailRepositoryConnection, context: se.model.Resource = null)(implicit lg:org.slf4j.Logger) extends RDFHandler with ParseErrorListener{
