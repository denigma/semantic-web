  ...
  */
  ...
  "Query Modifiers" should {
    ...
    "query with bindings" in new WithApplication() {
      ...
      val resBinded= SP.js.bindedQuery(query,Map("o"->new URIImpl("http://denigma.org/actors/resources/RDF")))
